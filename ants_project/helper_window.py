...
def determine_clusters(x_f,y_f,epsilon,min_samples,w_size=3,dist=0.30,neighbors=25):

    df = pickle.load(open('../output/umap/window-%d/%.2f-%d.pkl'%(w_size,dist,neighbors),'rb'))
...
def interact_box(labels,x_f,y_f,colony,individual=0,setup_type=0,cluster=0,w_size=3,dist=0.30,neighbors=25):
